...
IMAGES="ubi8-openjdk-17-runtime ubi8-openjdk-17-runtime-updated ubi9-openjdk-17-runtime"
rm -f scan-result/trivy-scan-result.txt
for IMAGE in $IMAGES; do
    ...
    printf "************ Scan $IMAGE ************\n"
    trivy image --ignore-unfixed --security-checks vuln quay.io/voravitl/backend:$IMAGE >> scan-result/trivy-scan-result.txt
done
